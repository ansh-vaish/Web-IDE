...
const MainPlaygroundPage = () => {
  ...
  if (error) {
    // Special UI for private playgrounds
    if (error === "PRIVATE_PLAYGROUND") {
      return (
        <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] w-full p-4">
          <Lock className="h-12 w-12 text-amber-500 mb-4" />
          <h2 className="text-xl font-semibold text-amber-600 mb-2">
            Private Playground
          </h2>
          <p className="text-gray-600 mb-4">
            This playground is private and only accessible by its creator.
          </p>
